...
Bu dokuman repo kokundeki `docs/sinfim-design` klasorundeki Stitch AI ciktisini Sinfim.uz planina baglamak icin hazirlandi.

## Genel Karar

`docs/sinfim-design` ciktisi MVP icin kullanilabilir bir gorsel yon veriyor. Ikinci prompt sonrasi ekranlar artik mobil app degil, desktop-first web SaaS dashboard mantigina daha yakin.
...
- Ana referans tasarim sistemi: `docs/sinfim-design/scholar_slate/DESIGN.md`.

Marka icin canonical kaynak: `docs/projects/lms/docs/brand-constants.md`.
...
Ayni ekranin `_1` ve `_2` versiyonu varsa `_2` genelde Sinfim markasina daha yakin. Implementation referansi olarak asagidaki secim kullanilacak:
...
| Course Detail | `course_detail` | Layout iyi, course icerigi Sinfim'e uyarlanacak |
...
- MVP'de urun dili sonradan kararlastirilabilir, fakat tasarim implementasyonunda Sinfim ve Ozbekistan egitim pazari hissi korunmali.
...
Tasarim yonu kabul edilebilir. En buyuk risk gorsel layout degil, ciktinin icinde kalan yanlis marka ve auth metinleri. Ilk implementation adiminda tasarim kodu birebir alinmadan once Sinfim domain kararlarina gore temizlenmis component map cikartilmali.
